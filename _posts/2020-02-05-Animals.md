...
A final note about the code: I had to omit some parts towards the very end for the sake of readability, but I will make the notebook entirely available on my github.
