...
And that's it ! In this article, I've presented some basic tools of Natural Language Processing and how they can be used by any company wishing to gain some quantifiable insights from text data. 
