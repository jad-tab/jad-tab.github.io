...
CrabMobile's data science team performed some web scraping across platforms (Instagram, Facebook...) and were able to give me an initial dataset.  Here is part some of its categories:
...
As we have seen in the instagram post, real world data from social media posts is not as clean as a lexicon. Some technical difficulties that I was faced with are:
