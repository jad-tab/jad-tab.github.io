...
Simply put, it is a way to 'cluster' topics in a corpus, and to find out which words tend to occur together to form a topic. In R, the LDA requires us to choose the number of topics, and to provide a DocumentTermMatrix. Furthermore, it requires that the DocumentTermMatrix is not singular
