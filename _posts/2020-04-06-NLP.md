...
Spoiler: Statistics to the rescue !
...
CrabMobile is a telecom company based in Dubai, founded by foreign investor Eli.
They've just released a new service and are advertising it. Let's take a look at one of their instagram posts:

![alt]({{ site.url }}{{ site.baseurl }}/stc/insta.PNG)


Users are leaving comments on this service, some of it is more 
