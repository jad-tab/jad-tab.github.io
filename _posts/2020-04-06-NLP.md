...
After exploring some aspects of the dataset, we could come to ask some more serious questions. Are there recurring themes in our customers' inputs ? Do some problems occur together ? Is there a way to automatically label problems based on the words used in a post?
...
Simply put, it is a way to 'cluster' topics in a corpus, and to find out which words tend to occur together to form a topic.
