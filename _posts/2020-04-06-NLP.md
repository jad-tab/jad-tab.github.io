...
Instead, I am going to present the general methodology using mock data from one of their competitors: CrabMobile. The first sections of this article will be a simple but important exploratory analysis of the data. The second part will use slightly more theoretical tools. 
