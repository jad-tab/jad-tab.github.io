...
And that's it ! In this article, I've presented some basic tools of NLP and how they can be used by any company to gain some quantifiable insights from text. 

By the way, CrabMobile is not a real name...
